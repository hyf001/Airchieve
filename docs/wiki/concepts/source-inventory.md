...
- 外部供应商接口参考以 `raw/articles/external/*.md` 为准；这些文件保存来源 URL、摄取日期、关键契约和 AIrchieve 实现映射，不复制完整第三方文档正文。Kling Avatar 以官方 `klingai.com/document-api/apiReference/model/avatar` 和通用鉴权页为准。
