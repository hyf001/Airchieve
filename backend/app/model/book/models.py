...
class Book(TimestampMixin, Base):
    ...
    age_range_ids: Mapped[list[int]] = mapped_column(JSON, nullable=False, default=list)
    theme_ids: Mapped[list[int]] = mapped_column(JSON, nullable=False, default=list)
    education_goal_ids: Mapped[list[int]] = mapped_column(JSON, nullable=False, default=list)
    ...
    art_style_id: Mapped[int | None] = mapped_column(Integer, nullable=True)
