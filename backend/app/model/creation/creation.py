...
class CreationSession(TimestampMixin, Base):
    ...
    duplicated_from_session_id: Mapped[int | None] = mapped_column(Integer, nullable=True, index=True)
    title_snapshot: Mapped[str | None] = mapped_column(String(160), nullable=True)
