...
from app.service.asset.background_music import (
    assert_background_music_usable,
    create_background_music,
    create_system_background_music,
    delete_background_music,
    delete_system_background_music,
    get_admin_system_background_music,
    get_background_music,
    list_admin_system_background_music,
    list_background_music,
    set_default_background_music,
    update_background_music,
    update_system_background_music,
)
...
async def assert_asset_usable(db: AsyncSession, user_id: int, asset_type: str, asset_id: int) -> AssetInternalDTO:
    ...
    if asset_type == "background_music":
        return await assert_background_music_usable(db, user_id, asset_id)
