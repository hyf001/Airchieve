...
class Settings(BaseSettings):
    ...
    AI_PROVIDER_AUDIO: str | None = "kling"
    AI_PROVIDER_LIP_SYNC: str | None = "kling"
    ...
    ALIYUN_TTS_ACCESS_KEY_ID: str | None = None
    ALIYUN_TTS_ACCESS_KEY_SECRET: str | None = None
    ALIYUN_TTS_APP_KEY: str | None = None
    ALIYUN_TTS_TOKEN: str | None = None
    ALIYUN_TTS_TOKEN_DOMAIN: str = "cn-shanghai"
    ALIYUN_TTS_TOKEN_URL: str = "nls-meta.cn-shanghai.aliyuncs.com"
    ALIYUN_TTS_URL: str = "wss://nls-gateway.cn-shanghai.aliyuncs.com/ws/v1"
    ...
    ALIYUN_TTS_START_TIMEOUT_SECONDS: int = 10
    ALIYUN_TTS_COMPLETED_TIMEOUT_SECONDS: int = 120
    ALIYUN_TTS_LONG_TEXT: bool = False
    KLING_ACCESS_KEY: str | None = None
    KLING_SECRET_KEY: str | None = None
    KLING_BASE_URL: str | None = None
    KLING_TTS_SUBMIT_PATH: str = "/v1/audio/tts"
    KLING_TTS_STATUS_PATH: str = "/v1/audio/tts/{task_id}"
    KLING_TTS_VOICE_LANGUAGE: str = "zh"
    KLING_TTS_VOICE_SPEED: float = 1.0
    KLING_TTS_TIMEOUT_SECONDS: int = 180
    KLING_TTS_POLL_INTERVAL_SECONDS: float = 2.0
    KLING_AVATAR_MODE: str = "std"
    KLING_AVATAR_SUBMIT_PATH: str = "/v1/videos/avatar/image2video"
    KLING_AVATAR_STATUS_PATH: str = "/v1/videos/avatar/image2video/{task_id}"
    ...
    KLING_AVATAR_ACCESS_KEY: str | None = None
    KLING_AVATAR_SECRET_KEY: str | None = None
    KLING_AVATAR_BASE_URL: str | None = "https://api-beijing.klingai.com"
